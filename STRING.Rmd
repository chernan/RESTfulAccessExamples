...
Remote access to the database can be achieved by either direct request to the STRING API or by using the STRINGdb R library. Requests sent to the STRING website are relatively fast compared to other ressources.
